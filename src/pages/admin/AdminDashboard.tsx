    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1">
          <h1 className="text-2xl sm:text-3xl font-bold font-serif-institutional text-[#0f172a] tracking-tight">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            leftIcon={<Building2 className="w-4 h-4 text-[#475569]" />}
          >
            Academic Structure
          </Button>
        </div>
      ...
      {isLoading && students.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
          ...
          >
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-[#475569]">Total Students</p>
              <h3 className="text-2xl sm:text-3xl font-extrabold font-serif-institutional text-[#0f172a] mt-1 font-mono">
                {totalStudents}
              </h3>
              <span className="text-xs text-emerald-800 font-bold">Active Enrolled</span>
            </div>
            <div className="w-10 h-10 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-center text-[#0f172a] shadow-xs">
          ...
          >
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-[#475569]">Total Faculty</p>
              <h3 className="text-2xl sm:text-3xl font-extrabold font-serif-institutional text-[#0f172a] mt-1 font-mono">
                {totalFaculty}
              </h3>
              <span className="text-xs text-[#475569] font-semibold">Faculty Members</span>
            </div>
            <div className="w-10 h-10 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-center text-[#0f172a] shadow-xs">
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-xs flex items-center justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-[#475569]">Active Accounts</p>
              <h3 className="text-2xl sm:text-3xl font-extrabold font-serif-institutional text-[#0f172a] mt-1 font-mono">
                {activeAccountsCount}
              </h3>
              <span className="text-xs text-emerald-800 font-bold">Verified & Enabled</span>
            </div>
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-xs flex items-center justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-[#475569]">Blocked Accounts</p>
              <h3 className={`text-2xl sm:text-3xl font-extrabold font-serif-institutional mt-1 font-mono ${blockedAccountsCount > 0 ? 'text-amber-800' : 'text-[#0f172a]'}`}>
                {blockedAccountsCount}
              </h3>
              <span className={`text-xs font-bold ${blockedAccountsCount > 0 ? 'text-amber-800' : 'text-[#475569]'}`}>
                {blockedAccountsCount > 0 ? 'Access Restricted' : 'Zero Blocked'}
              </span>
            </div>
            <div className={`w-10 h-10 rounded-xl border flex items-center justify-center shadow-xs ${blockedAccountsCount > 0 ? 'bg-amber-50 border-amber-200 text-amber-800' : 'bg-slate-100 border border-slate-200 text-[#475569]'}`}>
          ...
          >
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-[#475569]">Academic Structure</p>
              <h3 className="text-2xl sm:text-3xl font-extrabold font-serif-institutional text-[#0f172a] mt-1 font-mono">
                {totalDepts}
              </h3>
              <span className="text-xs text-[#475569] font-semibold">{totalPrograms} Programs</span>
            </div>
            <div className="w-10 h-10 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-center text-[#0f172a] shadow-xs">
        ...
        <div className="lg:col-span-7 bg-white rounded-3xl p-6 sm:p-7 border border-slate-200/80 shadow-xs flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-lg font-bold font-serif-institutional text-[#0f172a] tracking-tight">
                  Account Governance & Directory Status
                </h3>
                <p className="text-[15px] text-[#475569] mt-0.5 font-medium">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold uppercase tracking-wider text-[#475569]">Faculty Accounts</span>
                  <Users className="w-4 h-4 text-[#0f172a]" />
                </div>
                <div className="text-2xl font-extrabold font-serif-institutional text-[#0f172a] mt-2 font-mono">{facultyAccountsCount}</div>
                <div className="flex items-center justify-between text-xs text-[#475569] mt-2 pt-2 border-t border-slate-200 font-medium">
                  <span>Directory: Active</span>
                  <span className="text-[#0f172a] font-bold">Manage →</span>
                </div>
              </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold uppercase tracking-wider text-[#475569]">Student Accounts</span>
                  <GraduationCap className="w-4 h-4 text-[#0f172a]" />
                </div>
                <div className="text-2xl font-extrabold font-serif-institutional text-[#0f172a] mt-2 font-mono">{studentAccountsCount}</div>
                <div className="flex items-center justify-between text-xs text-[#475569] mt-2 pt-2 border-t border-slate-200 font-medium">
                  <span>Directory: Active</span>
                  <span className="text-[#0f172a] font-bold">Manage →</span>
                </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 mt-4 space-y-2">
              ...
              <ul className="text-xs text-[#334155] space-y-1.5 pl-6 list-disc font-medium">
          ...
          <div className="pt-4 border-t border-slate-100 mt-6 flex items-center justify-between text-xs text-[#475569] font-medium">
            ...
            <div className="flex items-center gap-2 font-medium">
              ...
              <button 
                ...
                className="text-[#475569] hover:text-[#0f172a] font-semibold hover:underline flex items-center gap-1 cursor-pointer"
              >
        ...
        <div className="lg:col-span-5 bg-white rounded-3xl p-6 sm:p-7 border border-slate-200/80 shadow-xs flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="z-10">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-[15px] text-[#475569] mt-0.5 font-medium">Live security & account operations</p>
              </div>
              <button onClick={() => onNavigate('audit_logs')} className="text-xs font-bold text-[#0f172a] hover:underline cursor-pointer">
                View All Logs →
              </button>
            </div>

            {displayLogs.length === 0 ? (
              <div className="py-12 text-center text-[#475569] text-xs flex flex-col items-center justify-center">
                <History className="w-8 h-8 text-[#475569] mb-2 opacity-50" />
                <p className="font-bold text-[#0f172a] text-sm">No recent account activity</p>
                <p className="text-xs text-[#475569] mt-1 font-medium">Audit trail events will appear here in real time.</p>
              </div>
            ) : (
                ...
                {displayLogs.map((log, idx) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between text-xs text-[#475569] mt-0.5 font-mono font-medium">
          ...
          <div className="pt-4 border-t border-slate-100 mt-4 z-10">
            <Button
              ...
              leftIcon={<History className="w-3.5 h-3.5 text-[#475569]" />}
            >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        >
          <Users className="w-5 h-5 text-[#475569] group-hover:text-[#0f172a] mb-2 transition-colors" />
          <h4 className="text-sm font-bold text-[#0f172a]">Faculty Accounts</h4>
          <p className="text-xs text-[#475569] mt-0.5 font-medium">Security, credentials & status</p>
        </button>
        ...
        <button
          ...
          className="p-4 rounded-2xl bg-white border border-slate-200/80 hover:border-slate-300 hover:shadow-xs transition-all text-left group shadow-xs cursor-pointer"
        >
          <GraduationCap className="w-5 h-5 text-[#475569] group-hover:text-[#0f172a] mb-2 transition-colors" />
          <h4 className="text-sm font-bold text-[#0f172a]">Student Accounts</h4>
          <p className="text-xs text-[#475569] mt-0.5 font-medium">Enrollments, year/sec & access</p>
        </button>
        ...
        <button
          ...
          className="p-4 rounded-2xl bg-white border border-slate-200/80 hover:border-slate-300 hover:shadow-xs transition-all text-left group shadow-xs cursor-pointer"
        >
          <Building2 className="w-5 h-5 text-[#475569] group-hover:text-[#0f172a] mb-2 transition-colors" />
          <h4 className="text-sm font-bold text-[#0f172a]">Academic Structure</h4>
          <p className="text-xs text-[#475569] mt-0.5 font-medium">Programs, departments & years</p>
        </button>
        ...
        <button
          ...
          className="p-4 rounded-2xl bg-white border border-slate-200/80 hover:border-slate-300 hover:shadow-xs transition-all text-left group shadow-xs cursor-pointer"
        >
          <History className="w-5 h-5 text-[#475569] group-hover:text-[#0f172a] mb-2 transition-colors" />
          <h4 className="text-sm font-bold text-[#0f172a]">Audit Trails & Logs</h4>
          <p className="text-xs text-[#475569] mt-0.5 font-medium">Immutable governance ledger</p>
        </button>
      </div>
