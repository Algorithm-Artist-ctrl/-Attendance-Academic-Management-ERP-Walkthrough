          ...
          <div className="space-y-5">
            ...
            <div className="p-4 rounded-2xl bg-slate-950/70 border border-emerald-500/20 space-y-3">
              ...
              <p className="text-[11px] text-slate-400">
                Passwords are never stored or displayed in plaintext. Triggering "Send Reset Link" emails official reset instructions to <span className="text-white font-mono">{selectedAccount.email}</span> and audits the event.
              </p>
            </div>
