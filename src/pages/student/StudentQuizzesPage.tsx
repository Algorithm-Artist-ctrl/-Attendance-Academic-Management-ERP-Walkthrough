        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-900 font-serif-institutional tracking-tight">Academic Quizzes & Assessments</h1>
                  ...
                  {myResult && (
                    <div className="mt-4 p-3 bg-slate-50 border border-slate-200/80 rounded-xl flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-semibold text-slate-700">Evaluated Score:</span>
                      </div>
                ...
                <div className="mt-5 pt-3">
                  <a
                    ...
                    className={clsx(
                      ...
                      isActive ? "bg-[#0f172a] hover:bg-black text-white shadow-xs" : "bg-white hover:bg-slate-50 text-slate-800 border border-slate-300 shadow-xs"
                    )}
                  >
