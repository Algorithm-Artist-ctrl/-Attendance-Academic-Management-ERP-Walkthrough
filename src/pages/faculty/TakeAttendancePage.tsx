                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  ...
                  <button
                    ...
                    className={clsx(
                      ...
                      status === 'Present'
                        ...
                        : 'bg-white text-emerald-800 border border-emerald-300 hover:bg-emerald-50 hover:border-emerald-400 font-bold'
                    )}
                    title="Mark Present (P)"
                  >
                    <CheckCircle2 className="w-3.5 h-3.5" />
                    <span>P</span>
                    <span className="hidden sm:inline text-xs">RESENT</span>
                  </button>
                  ...
                  <button
                    ...
                    className={clsx(
                      'px-3.5 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5',
                      status === 'Absent'
                        ? 'bg-rose-700 text-white shadow-xs font-black scale-105'
                        : 'bg-white text-rose-800 border border-rose-300 hover:bg-rose-50 hover:border-rose-400 font-bold'
                    )}
                    title="Mark Absent (A)"
                  >
                    <XCircle className="w-3.5 h-3.5" />
                    <span>A</span>
                    <span className="hidden sm:inline text-xs">BSENT</span>
                  </button>
                </div>
              </div>
            );
